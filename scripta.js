...
// loop assigns results(name of stored city)
   ...
   //       var retrievedData = localStorage.getItem("savedCities"); 
   //       var answer = JSON.stringify(retrievedData);
   //       console.log("results are " + answer);                                                                                                              
   //     }  
   //     for(i=0; i < results.length; i++) {
   //          var newBtn = $("<button class='historyBtn btn btn-primary'>" + results[i] + "</button>");
   //          storeButton(newBtn); 
   //          $("#cityName").append( newBtn);                                                                        
   //     }
